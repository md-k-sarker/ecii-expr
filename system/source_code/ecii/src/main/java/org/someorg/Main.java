...
import org.someorg.core.CandidateSolutionFinder;
import org.someorg.exceptions.MalFormedIRIException;
...
public class Main {
    ...
    static String alreadyGotResultPath = "";
    ...
    private static void doOps() throws OWLOntologyCreationException, IOException, MalFormedIRIException {
        ...
        monitor.writeMessage("Working with confFile: " + ConfigParams.confFilePath);
        // load ontotology
        ...
        findConceptsObj.printSolutions();
