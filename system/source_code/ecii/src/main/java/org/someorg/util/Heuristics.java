...
/**
 * Heuristics for computing accuracy metrices. Taken from dl-learner source code and modified some methods.
 */
public class Heuristics {
    ...
    /**
     * @param nrOfPositiveClassifiedAsPositive
     * @param nrOfNegativeClassifiedAsPositive
     * @return precision
     */
    public static double getPrecision(double nrOfPositiveClassifiedAsPositive, double nrOfNegativeClassifiedAsPositive) {
        double gotTotal = (double) nrOfPositiveClassifiedAsPositive + nrOfNegativeClassifiedAsPositive;

        return gotTotal == 0 ? 0 : (double) nrOfPositiveClassifiedAsPositive / (gotTotal);
    }

    /**
     * @param nrOfPositiveClassifiedAsPositive
     * @param nrOfPositiveClassifiedAsNegative
     * @return recall
     */
    public static double getRecall(double nrOfPositiveClassifiedAsPositive, double nrOfPositiveClassifiedAsNegative) {
        double gotTotal = nrOfPositiveClassifiedAsPositive + nrOfPositiveClassifiedAsNegative;
    ...
    /**
     * Computes Coverage-Score. For coverage positive and negative both has 50% share.
     * <p>
     * int nrOfPositiveClassifiedAsPositive, int totalPositive, int nrOfNegativeClassifiedAsNegative, int totalNegative
     *
     * @return Coverage-Score.
     */
    public static double getCoveragePosNegEqualShare(double nrOfPositiveClassifiedAsPositive, double totalPositive, double nrOfNegativeClassifiedAsNegative, double totalNegative) {

        if (totalPositive == 0) {
            return 0;
        } else if (totalNegative == 0) {
            return ((double) nrOfPositiveClassifiedAsPositive / totalPositive);
        } else {

            double posSide = ((double) nrOfPositiveClassifiedAsPositive / totalPositive);
            double negSide = ((double) nrOfNegativeClassifiedAsNegative / totalNegative);
            double invertedNegSide = 1.0 - negSide;
            double avg = ((posSide + invertedNegSide) / 2.0);

//            logger.info("else: score, nrOfPositiveClassifiedAsPositive=" + nrOfPositiveClassifiedAsPositive);
//            logger.info("else: score, totalPositive=" + totalPositive);
//            logger.info("else: score, posSide=" + posSide);
//            logger.info("else: score, negSide=" + negSide);
//            logger.info("else: score, invertedNegSide=" + invertedNegSide);
//            logger.info("else: score, avg=" + avg);

            //logger.info("else: score=" + ((((nrOfPositiveClassifiedAsPositive / totalPositive) + (1.0 - (nrOfNegativeClassifiedAsNegative / totalNegative))) / 2.0)));
            // return (((nrOfPositiveClassifiedAsPositive / totalPositive) + (1 - (nrOfNegativeClassifiedAsNegative / totalNegative))) / 2);
            return avg;
        }
    }
    ...
    /**
     * Computes Coverage-Score. For coverage positive and negative both has same weighted share.
     * <p>
     * int nrOfPositiveClassifiedAsPositive, int totalPositive, int nrOfNegativeClassifiedAsNegative, int totalNegative
     *
     * @return Coverage-Score.
     */
    public static double getCoverage(double nrOfPositiveClassifiedAsPositive, double totalPositive, double nrOfNegativeClassifiedAsNegative, double totalNegative) {

        double weightedCov = ((double) (nrOfPositiveClassifiedAsPositive + nrOfNegativeClassifiedAsNegative)) / ((double) (totalPositive + totalNegative));
