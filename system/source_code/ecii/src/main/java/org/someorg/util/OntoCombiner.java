...
public class OntoCombiner {
    ...
    private static String sumoPath = "somePath/" +
            "sumo_without_indi_fresh.owl";

    private static String OntoCombinerLogPath = "somePath/" +
            "logs/OntoCombiner_training_a.log";
    private static String OntoCombinerSavingPath = "somePath/" +
            "sumo_with_ade_training_a.owl";
    private static String traversingRootPath = "somePath/a/";
