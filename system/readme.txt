This directory contains the program and experimental data.

This folder contains the source code and the application.


    ecii.jar is a compiled jar file and executable.  Which can be run with command
    java -jar ecii.jar [parameters]

    source_code folder contains the source code of the application. Executable package can be created by using apache maven build system. Command:
    mvn clean package
